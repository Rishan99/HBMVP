...
- **Request Body:**
  - `data:{"name":"","price":null,"propertyTypeId":null,"address":"","description":""}`: JSON string containing property details.
...
- **Parameters:**
  ...
  - Required for authentication.
- **Request Body:**
  - `data:{"name":"","price":null,"propertyTypeId":null,"address":"","description":""}`: JSON string containing updated property details.
  - `Images`: Files representing property images.
- **Response:**
